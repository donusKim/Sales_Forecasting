...
if __name__ == '__main__':
    ...
    ## dataset 생성 함수 불러오기
    train_data = train_generator(new_df,new_temp,new_rain,new_trend, timesteps, date(2019, 6, 2),n_range=40, batch_size=30)
    ...
    ####훈련
    history = model.fit_generator(train_data, steps_per_epoch=steps_per_epoch, workers=4, use_multiprocessing=True, epochs=epochs, verbose=1,
